...
import { ThunderboltOutlined, RocketOutlined, ClockCircleOutlined, SafetyOutlined, 
  EnvironmentOutlined, TeamOutlined,
  CrownOutlined, StarOutlined, SafetyCertificateOutlined } from '@ant-design/icons';
...
function Home() {
  ...
  useEffect(() => {
    ...
    const animationTimers = [
      setTimeout(() => setAnimatedElements(prev => ({ ...prev, features: true })), 800),
      setTimeout(() => setAnimatedElements(prev => ({ ...prev, testimonials: true })), 1300),
      setTimeout(() => setAnimatedElements(prev => ({ ...prev, stats: true })), 1800),
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <div ref={sparklesContainerRef} style={{ 
        position: 'fixed',
        top: 0,
        left: 0,
        width: '100%',
      ...
      <section 
        ...
        <div className="luxury-parallax" data-speed="0.15" style={{ 
          position: 'absolute',
          top: 0,
          left: 0,
          width: '100%',
          height: '120%',
          background: 'linear-gradient(135deg, rgba(10,10,10,0.8) 0%, rgba(0,38,77,0.9) 100%)',
          opacity: 1,
          zIndex: 1
        }} />
        ...
        <div style={{ 
          ...
          width: '100%',
          height: '100%',
          background: 'url("data:image/svg+xml,%3Csvg width=\'40\' height=\'40\' viewBox=\'0 0 40 40\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M0 0h40v40H0V0zm20 20a2 2 0 110-4 2 2 0 010 4zm0 20a2 2 0 110-4 2 2 0 010 4zm20-20a2 2 0 110-4 2 2 0 010 4z\' fill=\'%23FFFFFF\' fill-opacity=\'0.05\' fill-rule=\'evenodd\'/%3E%3C/svg%3E")',
        ...
        {[...Array(12)].map((_, i) => (
          <div key={`tesla-orb-${i}`} style={{ 
            ...
            borderRadius: '50%', 
            background: `radial-gradient(circle, rgba(0,127,255,${Math.random() * 0.2 + 0.05}) 0%, rgba(0,0,0,0) 80%)`,
            filter: 'blur(30px)',
            zIndex: 1,
            animation: `float3d ${Math.random() * 10 + 10}s infinite cubic-bezier(0.2, 0.8, 0.2, 1) ${Math.random() * 5}s`,
            transformStyle: 'preserve-3d',
            opacity: 0.7
          }} />
        ))}
        ...
        <div style={{ 
          ...
          height: '200px',
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(0,127,255,0.1) 0%, rgba(0,0,0,0) 70%)',
        ...
        <div className="container-3d tesla-reveal-section" style={{ 
          maxWidth: '1300px',
          margin: '0 auto',
          padding: '0 32px',
          position: 'relative',
          ...
          <Row gutter={[60, 36]} align="middle">
            <Col xs={24} md={14} style={{ 
              ...
              transform: animatedElements.hero ? 'translateZ(60px) translateY(0)' : 'translateZ(0) translateY(40px)', 
              transition: 'all 1.2s cubic-bezier(0.2, 0.8, 0.2, 1)',
              transformStyle: 'preserve-3d',
              animation: animatedElements.hero ? 'tesla-reveal 1.2s cubic-bezier(0.2, 0.8, 0.2, 1)' : 'none'
            }}>
              <div style={{ marginBottom: '32px' }}>
                <div className="tesla-glass" style={{ 
                  display: 'inline-flex',
                  alignItems: 'center',
                  padding: '10px 20px',
                  borderRadius: '30px',
                  ...
                  <span style={{ 
                    ...
                    fontSize: '16px',
                    letterSpacing: '0.5px'
                  }}>Nạp đầy pin chỉ trong 5 phút</span>
                </div>
              </div>
              ...
              <Title level={1} className="luxury-heading" style={{ 
                fontSize: '62px', 
                fontWeight: 600, 
                lineHeight: 1.1, 
                marginBottom: '32px',
                ...
                <span style={{
                  ...
                  HỆ THỐNG ĐỔI PIN <br/>
                  <div className="luxury-divider" style={{ margin: '8px 0 16px' }}></div>
                  <span style={{
                    fontWeight: 700,
                    letterSpacing: '1px',
                    position: 'relative',
              ...
              <Paragraph className="luxury-subheading luxury-reveal delay-1 visible" style={{ 
                fontSize: '20px', 
                maxWidth: '600px',
                lineHeight: 1.6,
                position: 'relative',
              }}>
                <span className="signature-line"></span> Trải nghiệm đẳng cấp thượng lưu <span className="signature-line"></span><br/>
                Giải pháp đổi pin siêu tốc, sang trọng và đẳng cấp dành riêng cho khách hàng VIP. 
                Mạng lưới trạm cao cấp trên toàn quốc với công nghệ vượt trội.
              </Paragraph>
              ...
              <div style={{ 
                ...
                <Link to="/login">
                  ...
                  >
                    <CrownOutlined style={{ marginRight: '10px' }} /> ĐĂNG NHẬP VIP
                  </Button>
                </Link>
                <Button size="large" 
                ...
                >
                  <StarOutlined style={{ marginRight: '10px' }} /> TRẠM VIP GẦN NHẤT
                </Button>
              </div>
              
              <div className="luxury-border luxury-reveal delay-4 visible" style={{ 
                marginTop: '60px',
                padding: '20px 30px',
                maxWidth: '600px'
              }}>
                <div style={{ 
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <div className="luxury-icon" style={{ background: 'rgba(212, 175, 55, 0.1)', padding: '10px', borderRadius: '50%' }}>
                      <StarOutlined style={{ color: 'var(--luxury-gold)', fontSize: '22px' }} />
                    </div>
                    <span style={{ color: 'white', fontWeight: '500', letterSpacing: '0.5px' }}>Siêu Cao Cấp</span>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <div className="luxury-icon" style={{ background: 'rgba(212, 175, 55, 0.1)', padding: '10px', borderRadius: '50%' }}>
                      <SafetyCertificateOutlined style={{ color: 'var(--luxury-gold)', fontSize: '22px' }} />
                    </div>
                    <span style={{ color: 'white', fontWeight: '500', letterSpacing: '0.5px' }}>Độc Quyền VIP</span>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <div className="luxury-icon" style={{ background: 'rgba(212, 175, 55, 0.1)', padding: '10px', borderRadius: '50%' }}>
                      <CrownOutlined style={{ color: 'var(--luxury-gold)', fontSize: '22px' }} />
                    </div>
                    <span style={{ color: 'white', fontWeight: '500', letterSpacing: '0.5px' }}>Đẳng Cấp</span>
                  </div>
                </div>
              </div>
            </Col>
            ...
            <Col xs={24} md={10} style={{ 
              opacity: animatedElements.hero ? 1 : 0, 
              transform: animatedElements.hero ? 'translateZ(60px) rotateY(-5deg) translateY(0)' : 'translateZ(0) translateY(20px)', 
              transition: 'all 1.2s cubic-bezier(0.16, 1, 0.3, 1)',
              transitionDelay: '0.3s',
              transformStyle: 'preserve-3d'
            }}>
              <div className="luxury-glass-card luxury-3d luxury-depth luxury-reveal delay-2 visible" style={{ 
                position: 'relative',
                borderRadius: '20px',
                overflow: 'hidden',
                ...
                <div style={{
                  ...
                  right: 0,
                  bottom: 0,
                  background: 'radial-gradient(circle at 30% 30%, rgba(66, 153, 225, 0.15) 0%, rgba(0,0,0,0) 60%)',
                  zIndex: 1,
                }}></div>
                ...
                <div style={{ 
                  ...
                  boxShadow: '0 20px 40px rgba(0,0,0,0.4), inset 0 0 20px rgba(0,255,0,0.05)',
                  transition: 'transform 0.5s ease',
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = 'translateZ(60px) rotateY(-5deg)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = 'translateZ(30px) rotateY(10deg)';
                }}>
                  ...
                  <div style={{ 
                    ...
                    boxShadow: 'inset 0 10px 20px rgba(255,255,255,0.3), 0 0 30px rgba(212, 175, 55, 0.5)',
                    position: 'relative',
                    overflow: 'hidden'
                  }}>
                    {/* Energy glow effect */}
                    <div style={{
                      ...
                      width: '100%',
                      height: '100%',
                      background: 'radial-gradient(circle at center, rgba(255,255,255,0.2) 0%, rgba(76,175,80,0) 80%)',
        ...
        <div className="luxury-scroll-cta" onClick={scrollToFeatures} style={{
          position: 'absolute',
          bottom: '40px',
          left: '50%',
          transform: 'translateX(-50%)',
      ...
      <section 
        ...
        style={{ 
          padding: '120px 0',
          background: 'linear-gradient(135deg, var(--luxury-dark) 0%, var(--luxury-blue) 100%)',
          position: 'relative',
          overflow: 'hidden',
          perspective: '1200px'
      }}>
        <div style={{ 
          ...
          <div style={{ 
            ...
            transform: animatedElements.features ? 'translateZ(40px) translateY(0)' : 'translateZ(0) translateY(20px)', 
            transition: 'all 0.8s cubic-bezier(0.175, 0.885, 0.32, 1.275)',
            transformStyle: 'preserve-3d',
          }}>
            <div className="luxury-badge" style={{ margin: '0 auto', textAlign: 'center' }}>
              <CrownOutlined style={{ marginRight: '8px' }} />
              Dịch Vụ VIP
            </div>
            
            <Title level={2} className="luxury-heading" style={{ 
              fontSize: '42px', 
              fontWeight: 600, 
              marginBottom: '20px',
              position: 'relative',
              ...
              <span style={{
                position: 'relative',
                zIndex: 2
              }}>ĐẶC QUYỀN THƯỢNG LƯU</span>
            </Title>
            
            <div className="luxury-divider" style={{ margin: '0 auto 32px', width: '120px' }}></div>
            ...
            <Paragraph style={{ 
              ...
              Chúng tôi cung cấp dịch vụ đổi pin cao cấp, được thiết kế riêng cho khách hàng tinh hoa,
              mang lại trải nghiệm xa hoa và đẳng cấp khác biệt.
            </Paragraph>
          </div>
          ...
          <Row gutter={[32, 32]}>
            <Col xs={24} md={8} style={{ 
              opacity: animatedElements.features ? 1 : 0, 
              transform: animatedElements.features ? 'translateY(0)' : 'translateY(20px)', 
              ...
              hoverable>
                ...
                <Paragraph style={{ color: '#64748b', marginBottom: 0 }}>
                  Chỉ mất 5 phút để thực hiện việc thay đổi pin, giúp bạn tiếp tục hành trình mà không cần chờ đợi lâu.
                </Paragraph>
              </Card>
            </Col>
            ...
            <Col xs={24} md={8} style={{ 
              ...
              hoverable>
                ...
                <Paragraph style={{ color: '#64748b', marginBottom: 0 }}>
                  Mạng lưới trạm đổi pin rộng khắp, dễ dàng tìm thấy ở nhiều vị trí trung tâm và tiện lợi.
                </Paragraph>
              </Card>
            </Col>
            ...
            <Col xs={24} md={8} style={{ 
              ...
              hoverable>
                ...
                <Paragraph style={{ color: '#64748b', marginBottom: 0 }}>
                  Hệ thống kiểm tra pin kỹ lưỡng, đảm bảo an toàn tuyệt đối khi sử dụng với công nghệ tiên tiến.
                </Paragraph>
              </Card>
            </Col>
          </Row>
        ...
        <div style={{ 
          ...
          <Row gutter={[48, 32]}>
            <Col xs={24} sm={12} md={6} style={{ 
              ...
              transform: animatedElements.stats ? 'translateZ(30px) translateY(0)' : 'translateY(20px) translateZ(0)', 
              transition: 'all 0.8s cubic-bezier(0.175, 0.885, 0.32, 1.275)',
              transformStyle: 'preserve-3d',
              transitionDelay: '0.1s'
            }}>
              ...
              onMouseLeave={(e) => {
                ...
                <Statistic 
                  ...
                  prefix={<EnvironmentOutlined style={{ 
            ...
            <Col xs={24} sm={12} md={6} style={{ 
              opacity: animatedElements.stats ? 1 : 0, 
              transform: animatedElements.stats ? 'translateY(0)' : 'translateY(20px)', 
              transition: 'all 0.8s ease',
              transitionDelay: '0.2s'
            }}>
              <div style={{ textAlign: 'center' }}>
                <Statistic 
                  title={<div style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', marginBottom: '8px' }}>Người Dùng</div>}
                  value={50000}
            ...
            <Col xs={24} sm={12} md={6} style={{ 
              ...
              <div style={{ textAlign: 'center' }}>
                <Statistic 
                  title={<div style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', marginBottom: '8px' }}>Lượt Đổi Pin</div>}
                  value={100000}
                  valueStyle={{ color: 'white', fontSize: '36px', fontWeight: 'bold' }}
            ...
            <Col xs={24} sm={12} md={6} style={{ 
              ...
              <div style={{ textAlign: 'center' }}>
                <Statistic 
                  title={<div style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', marginBottom: '8px' }}>Tiết Kiệm CO2</div>}
                  value={250}
                  suffix="tấn"
                  valueStyle={{ color: 'white', fontSize: '36px', fontWeight: 'bold' }}
                />
      ...
      <section 
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            transform: animatedElements.cta ? 'translateY(0)' : 'translateY(20px)', 
            ...
            <Row gutter={[48, 48]} align="middle">
              <Col xs={24} md={16}>
                <Title level={2} style={{ 
                  ...
                  <span style={{
                    ...
                    <span style={{
                      ...
                      height: '4px',
                      width: '50%',
                      background: 'linear-gradient(90deg, rgba(255,193,7,1) 0%, rgba(255,193,7,0) 100%)',
                      bottom: '-8px',
                      left: '0',
                      transformStyle: 'preserve-3d',
                      transform: 'translateZ(-5px)'
                ...
                <Paragraph style={{ 
                  ...
                  Đăng ký ngay hôm nay để được hưởng nhiều ưu đãi đặc biệt dành cho thành viên mới. Đổi pin xe điện chưa bao giờ dễ dàng đến thế!
                </Paragraph>
              </Col>
                ...
                <Link to="/register">
                  <Button 
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow = '0 25px 40px rgba(255, 193, 7, 0.5), 0 0 30px rgba(255, 193, 7, 0.3)';
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.transform = 'translateZ(40px) scale(1.05)';
                      e.currentTarget.style.boxShadow = '0 15px 30px rgba(255, 193, 7, 0.4)';
                    }}
                  >
                    <div style={{
                      position: 'absolute',
        ...
        <div style={{ 
          ...
          <Row gutter={[48, 32]}>
            <Col xs={24} md={8} style={{ marginBottom: '24px' }}>
              ...
              <Paragraph style={{ color: 'rgba(255,255,255,0.6)', marginBottom: '24px' }}>
                Hệ thống quản lý trạm đổi pin xe điện hàng đầu Việt Nam. Chúng tôi cam kết mang đến trải nghiệm tốt nhất cho người dùng.
              </Paragraph>
              <div style={{ 
                display: 'flex', 
                gap: '16px'
            ...
            <Col xs={12} sm={8} md={5}>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '12px' }}>
                  <a href="#" style={{ color: 'rgba(255,255,255,0.6)', textDecoration: 'none' }}>Đổi Pin</a>
                </li>
                <li style={{ marginBottom: '12px' }}>
                  <a href="#" style={{ color: 'rgba(255,255,255,0.6)', textDecoration: 'none' }}>Sạc Pin</a>
                </li>
                <li style={{ marginBottom: '12px' }}>
                  <a href="#" style={{ color: 'rgba(255,255,255,0.6)', textDecoration: 'none' }}>Bảo Dưỡng</a>
                </li>
                <li style={{ marginBottom: '12px' }}>
                  <a href="#" style={{ color: 'rgba(255,255,255,0.6)', textDecoration: 'none' }}>Tư Vấn</a>
                </li>
              </ul>
            </Col>
            ...
            <Col xs={12} sm={8} md={5}>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '12px' }}>
                  <a href="#" style={{ color: 'rgba(255,255,255,0.6)', textDecoration: 'none' }}>Về Chúng Tôi</a>
                </li>
                <li style={{ marginBottom: '12px' }}>
                  <a href="#" style={{ color: 'rgba(255,255,255,0.6)', textDecoration: 'none' }}>Tuyển Dụng</a>
                </li>
                <li style={{ marginBottom: '12px' }}>
                  <a href="#" style={{ color: 'rgba(255,255,255,0.6)', textDecoration: 'none' }}>Đối Tác</a>
                </li>
                <li style={{ marginBottom: '12px' }}>
                  <a href="#" style={{ color: 'rgba(255,255,255,0.6)', textDecoration: 'none' }}>Tin Tức</a>
                </li>
              </ul>
            </Col>
            ...
            <Col xs={24} sm={8} md={6}>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '12px', color: 'rgba(255,255,255,0.6)' }}>
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <a href="#" style={{ color: 'inherit', textDecoration: 'none' }}>Chính Sách</a>
