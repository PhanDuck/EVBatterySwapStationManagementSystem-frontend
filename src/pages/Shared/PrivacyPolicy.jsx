      ...
      >
        ...
        <Col xs={24} md={18}>
          <Card style={{ boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>
            ...
            {/* Section 1 */}
            <h2 id="privacy-1" style={sectionStyle}>
              1. CAM KẾT BẢO MẬT
            </h2>
            <p style={textStyle}>
            ...
            {/* Section 2 */}
            <h2 id="privacy-2" style={sectionStyle}>
              2. DỮ LIỆU CHÚNG TÔI THU THẬP
            </h2>
            <h3 style={subsectionStyle}>2.1. Thông Tin Cá Nhân</h3>
            <ul style={{ marginLeft: "20px", marginBottom: "15px" }}>
              <li style={listItemStyle}>
                <strong>Thông tin định danh:</strong> Họ tên, Số điện thoại, Địa chỉ Email, CCCD/CMND (để xác minh hợp đồng thuê pin).
              </li>
              <li style={listItemStyle}>
                <strong>Thông tin tài khoản:</strong> Tên đăng nhập, mật khẩu (được mã hóa), ảnh đại diện.
              </li>
            </ul>
            ...
            <ul style={{ marginLeft: "20px", marginBottom: "15px" }}>
              <li style={listItemStyle}>
                Biển số xe, loại xe, số khung (VIN).
              </li>
              <li style={listItemStyle}>
                <strong>Dữ liệu pin (Telemetry):</strong> Lịch sử sạc/xả, trạng thái sức khỏe pin (SOH), nhiệt độ pin, quãng đường di chuyển. Đây là dữ liệu kỹ thuật cần thiết để đảm bảo an toàn vận hành.
              </li>
            </ul>
            ...
            <h2 id="privacy-3" style={sectionStyle}>
              3. DỮ LIỆU VỊ TRÍ & BẢN ĐỒ (QUAN TRỌNG)
            </h2>
            <div style={highlightStyle}>
              <strong style={{ color: "#2e7d32" }}>
                THÔNG BÁO VỀ QUYỀN TRUY CẬP VỊ TRÍ:
              </strong>
            ...
            <ul style={{ marginLeft: "20px", marginBottom: "15px" }}>
              <li style={listItemStyle}>
                <strong>Khi đặt lịch đổi pin:</strong> Hệ thống sử dụng vị trí để ước tính thời gian đến trạm và giữ chỗ.
              </li>
              <li style={listItemStyle}>
                Chúng tôi cam kết <strong>KHÔNG</strong> theo dõi lịch trình di chuyển cá nhân của bạn cho mục đích quảng cáo hoặc bán cho bên thứ ba.
              </li>
            </ul>

            {/* Section 4 */}
            <h2 id="privacy-4" style={sectionStyle}>
            ...
            <ol style={{ marginLeft: "20px", marginBottom: "15px" }}>
              <li style={listItemStyle}>
                Cung cấp dịch vụ đổi pin, xử lý giao dịch và quản lý gói thuê bao.
              </li>
              <li style={listItemStyle}>
                Gửi thông báo về tình trạng pin, nhắc nhở sạc pin hoặc bảo dưỡng xe.
              </li>
              <li style={listItemStyle}>
                Hỗ trợ khách hàng, giải quyết khiếu nại và sự cố kỹ thuật.
              </li>
              <li style={listItemStyle}>
                Phát hiện và ngăn chặn gian lận, trộm cắp pin hoặc phá hoại tài sản.
              </li>
              <li style={listItemStyle}>
                Gửi thông tin khuyến mãi, cập nhật tính năng mới (nếu bạn đồng ý nhận tin).
              </li>
            </ol>

            {/* Section 5 */}
            <h2 id="privacy-5" style={sectionStyle}>
              5. CHIA SẺ THÔNG TIN
            </h2>
            <p style={textStyle}>
            ...
            <ul style={{ marginLeft: "20px", marginBottom: "15px" }}>
              <li style={listItemStyle}>
                <strong>Đối tác vận hành trạm:</strong> Chỉ chia sẻ thông tin đặt lịch (Biển số xe, giờ đến) để nhân viên trạm chuẩn bị pin.
              </li>
              <li style={listItemStyle}>
                <strong>Cổng thanh toán:</strong> Để xử lý các giao dịch nạp tiền hoặc thanh toán gói cước.
              </li>
              <li style={listItemStyle}>
                <strong>Cơ quan pháp luật:</strong> Khi có yêu cầu hợp pháp từ cơ quan nhà nước có thẩm quyền (ví dụ: điều tra tai nạn, trộm cắp xe).
              </li>
            </ul>

            {/* Section 6 */}
            <h2 id="privacy-6" style={sectionStyle}>
              6. BẢO MẬT & LƯU TRỮ
            </h2>
            ...
            {/* Section 7 */}
            <h2 id="privacy-7" style={sectionStyle}>
            ...
            <ul style={{ marginLeft: "20px", marginBottom: "15px" }}>
              <li style={listItemStyle}>
                <strong>Quyền truy cập:</strong> Xem lại thông tin cá nhân và lịch sử giao dịch trong ứng dụng.
              </li>
              <li style={listItemStyle}>
                <strong>Quyền chỉnh sửa:</strong> Cập nhật thông tin cá nhân khi có thay đổi.
              </li>
              <li style={listItemStyle}>
                <strong>Quyền xóa bỏ:</strong> Yêu cầu xóa tài khoản và dữ liệu cá nhân vĩnh viễn (qua email hỗ trợ hoặc chức năng trong App).
              </li>
              <li style={listItemStyle}>
                <strong>Quyền từ chối:</strong> Tắt quyền truy cập vị trí (GPS) hoặc từ chối nhận email quảng cáo bất cứ lúc nào.
              </li>
            </ul>

            {/* Section 8 - Đã sửa lại theo Local Storage */}
            <h2 id="privacy-8" style={sectionStyle}>
              8. CÔNG NGHỆ LƯU TRỮ (LOCAL STORAGE)
            </h2>
            <p style={textStyle}>
              Website và ứng dụng của chúng tôi <strong>KHÔNG sử dụng Cookie</strong> để theo dõi hành vi người
              dùng.
            </p>
            <p style={textStyle}>
            ...
            {/* Section 9 */}
            <h2 id="privacy-9" style={sectionStyle}>
            ...
            {/* Section 10 */}
            <h2 id="privacy-10" style={sectionStyle}>
              10. LIÊN HỆ
            </h2>
            <div
              style={{
            ...
            >
              <p style={textStyle}>
                Nếu bạn có bất kỳ câu hỏi nào về bảo mật thông tin, vui lòng liên hệ Bộ phận Bảo mật dữ liệu:
              </p>
              <p style={{ ...textStyle, marginBottom: "5px" }}>
                <strong>EV Battery Swap System</strong>
              </p>
              <p style={{ ...textStyle, marginBottom: "5px" }}>
                Email: privacy@evbatteryswap.com
              </p>
              <p style={{ ...textStyle, marginBottom: "5px" }}>
                Hotline: 1900 xxxx
              </p>
              <p style={{ ...textStyle, marginBottom: "0" }}>
                Địa chỉ: Khu Công Nghệ Cao, TP. Thủ Đức, TP.HCM
              </p>
            </div>
          </Card>
        </Col>
