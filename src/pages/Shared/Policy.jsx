        ...
        <Col xs={24} md={18}>
          <Card style={{ boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>
            ...
            <ul style={{ marginLeft: "20px", marginBottom: "15px" }}>
              <li style={listItemStyle}><strong>Người Sử Dụng</strong>: Là cá nhân hoặc tổ chức đăng ký sử dụng dịch vụ qua hệ thống</li>
              <li style={listItemStyle}><strong>Nhà Cung Cấp Dịch Vụ</strong>: Công ty cung cấp dịch vụ lắp đặt, thay thế và sạc pin thông minh cho xe điện</li>
            </ul>
            ...
            <ul style={{ marginLeft: "20px", marginBottom: "15px" }}>
              <li style={listItemStyle}>Đã đăng ký tài khoản trên hệ thống và hoàn tất xác thực thông tin.</li>
              <li style={listItemStyle}>Đã đăng ký xe điện với hệ thống và được Admin/Staff phê duyệt.</li>
              <li style={listItemStyle}>Đã mua gói dịch vụ pin và đang trong thời hạn sử dụng hợp lệ.</li>
            </ul>
            ...
            <ul style={{ marginLeft: "20px", marginBottom: "15px" }}>
              <li style={listItemStyle}>Lắp đặt số lượng pin cần thiết để xe hoạt động bình thường.</li>
              <li style={listItemStyle}>Pin được cung cấp có trạng thái: <strong>đầy điện (SOC ≥ 95%), sức khỏe tốt (SOH ≥ 70%)</strong>.</li>
            </ul>
            ...
            <ol style={{ marginLeft: "20px", marginBottom: "15px" }}>
              <li style={listItemStyle}>Đặt lịch đổi pin qua hệ thống (tự động đặt trước 3 giờ).</li>
              <li style={listItemStyle}>Đến trạm vào đúng thời gian đã đặt.</li>
              <li style={listItemStyle}>Nhập mã xác nhận để thực hiện đổi pin tự động.</li>
            </ol>
            ...
            <ul style={{ marginLeft: "20px", marginBottom: "15px" }}>
              ...
              <li style={listItemStyle}>Ví dụ: Gói Basic (20 lượt/tháng, 400.000đ), Gói Standard (50 lượt/tháng, 800.000đ)</li>
            </ul>
            ...
            <ul style={{ marginLeft: "20px", marginBottom: "15px" }}>
              <li style={listItemStyle}>Tất cả pin trong hệ thống thuộc <strong>QUYỀN SỞ HỮU DUY NHẤT</strong> của nhà cung cấp dịch vụ.</li>
              <li style={listItemStyle}>Người dùng <strong>KHÔNG CÓ</strong> quyền sở hữu, quyền vật quyền, quyền sở hữu trí tuệ hoặc bất kỳ quyền nào khác đối với pin.</li>
              <li style={listItemStyle}>Người dùng chỉ có quyền <strong>SỬ DỤNG</strong> pin theo hợp đồng này.</li>
              <li style={listItemStyle}><strong>KHÔNG ĐƯỢC</strong> chuyển nhượng, cho thuê, bán hoặc thế chấp pin cho bất kỳ bên thứ ba nào.</li>
            </ul>
            ...
            <ul style={{ marginLeft: "20px", marginBottom: "15px" }}>
              <li style={listItemStyle}>Bảo quản pin theo nguyên tắc <strong>quản lý tốt nhất</strong> (như chính tài sản của mình).</li>
              <li style={listItemStyle}>Tuân thủ <strong>Quy Tắc Bảo Quản Pin</strong> tại <strong>Phụ LỤC B</strong>.</li>
            </ul>

            <h3 style={subsectionStyle}>7.2. Nghiêm Cấm</h3>
            <div style={highlightStyle}>
              <strong style={{ color: "#856404" }}>TUYỆT ĐỐI KHÔNG ĐƯỢC:</strong>
              <ol style={{ marginLeft: "20px", marginTop: "10px", marginBottom: "0" }}>
                <li style={listItemStyle}>Tự ý tháo rời, sửa chữa pin hoặc bất kỳ bộ phận nào của pin.</li>
                <li style={listItemStyle}>Mang pin ra ngoài lãnh thổ Việt Nam (trừ khi được phê duyệt bằng văn bản).</li>
                <li style={listItemStyle}>Vi phạm quyền sở hữu trí tuệ hoặc bí mật kinh doanh liên quan đến pin.</li>
                <li style={listItemStyle}>Cho bên thứ ba sử dụng pin ngoài mục đích của hợp đồng.</li>
              </ol>
            </div>
            ...
            <div style={{ backgroundColor: "#f0f0f0", padding: "15px", borderRadius: "8px", marginBottom: "20px" }}>
              ...
              <ul style={{ marginLeft: "20px", marginTop: "8px", marginBottom: "15px" }}>
                <li style={listItemStyle}><strong>NGHIÊM CẤM</strong> để pin ở nơi nhiệt độ cao hoặc phơi trực tiếp dưới nắng <strong>TRÊN 30 PHÚT</strong>.</li>
                <li style={listItemStyle}>Để pin ở nơi thoáng mát, khô ráo.</li>
              </ul>

              <strong>2. Sử Dụng Đúng Mục Đích</strong>
              <ul style={{ marginLeft: "20px", marginTop: "8px", marginBottom: "15px" }}>
                <li style={listItemStyle}><strong>NGHIÊM CẤM</strong> sử dụng pin cho mục đích không được phê duyệt.</li>
                <li style={listItemStyle}>Giữ cổng kết nối pin sạch sẽ, không có dị vật.</li>
              </ul>

              <strong>3. Bảo Vệ Vật Lý</strong>
              <ul style={{ marginLeft: "20px", marginTop: "8px", marginBottom: "15px" }}>
                <li style={listItemStyle}><strong>NGHIÊM CẤM</strong> ném pin vào lửa, hơ nóng, làm lạnh, ngâm nước, đập, thả rơi.</li>
                <li style={listItemStyle}><strong>NGHIÊM CẤM</strong> cố gắng tháo rời hoặc phá hủy pin.</li>
              </ul>

              <strong>4. Cấu Trúc & Hình Dáng</strong>
              <ul style={{ marginLeft: "20px", marginTop: "8px", marginBottom: "15px" }}>
                <li style={listItemStyle}><strong>NGHIÊM CẤM</strong> tự ý tháo rời hoặc thay đổi hình dáng, cấu trúc pin.</li>
                <li style={listItemStyle}><strong>NGHIÊM CẤM</strong> dán, sơn, khắc laser, hoặc thay đổi ngoại hình pin.</li>
              </ul>

              <strong>5. Sạc/Xả Điện</strong>
              <ul style={{ marginLeft: "20px", marginTop: "8px", marginBottom: "15px" }}>
                <li style={listItemStyle}><strong>NGHIÊM CẤM</strong> tự ý sạc hoặc xả điện pin bằng thiết bị không được phê duyệt.</li>
                <li style={listItemStyle}>Chỉ sạc pin tại trạm hoặc thiết bị được cấp phép chính thức.</li>
              </ul>

              <strong>6. Cất Giữ & Bảo Quản</strong>
              <ul style={{ marginLeft: "20px", marginTop: "8px", marginBottom: "0" }}>
                <li style={listItemStyle}>Bảo quản pin ở <strong>TƯ THẾ ĐỨNG THẲNG</strong>.</li>
                <li style={listItemStyle}><strong>KHÔNG</strong> để đồ đạc, vật dụng lên nắp pin.</li>
              </ul>
            </div>
            ...
            <p style={textStyle}>Khi <strong>XÁC ĐỊNH</strong> người dùng chịu trách nhiệm:</p>
            <ul style={{ marginLeft: "20px", marginBottom: "15px" }}>
              <li style={listItemStyle}>Người dùng phải trả <strong>GIÁ TRỊ THAY THẾ PIN</strong> tại thời điểm xảy ra sự cố.</li>
              <li style={listItemStyle}><strong>Giá trị hiện tại</strong>: <strong>25.000.000 VNĐ/viên pin</strong> (có thể thay đổi).</li>
            </ul>

            {/* Footer */}
            <div style={{ marginTop: "60px", paddingTop: "20px", borderTop: "1px solid #ddd", textAlign: "center", color: "#666" }}>
              <p>
                <strong>Hotline Hỗ Trợ:</strong> 098104xxxx<br />
