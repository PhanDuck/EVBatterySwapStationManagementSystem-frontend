...
const BatteryInfoCard = ({ title, batteryData, loading, type }) => {
  ...
  if (loading) {
    return (
      <Card bordered title={title} style={{ height: 250, textAlign: "center" }}>
  ...
  return (
    <Card bordered title={title} style={{ minHeight: 250, borderColor: color }}>
      <Space direction="vertical" style={{ width: "100%" }}>
        ...
        <Row justify="space-between">
          ...
          <Col>
            <Text>{batteryData.model || "N/A"}</Text>
          </Col>
        </Row>
...
const EnterConfirmationCode = () => {
  ...
  return (
    <div style={{ padding: "24px", minHeight: "80vh", display: 'flex', justifyContent: 'center' }}>
                            ...
                            {step === 2 && !oldBattery ? (
                                ...
                                >
                                    <Text type="secondary" style={{ textAlign: "center" }}>
                                        Bấm nút **Cho pin cũ vào** bên dưới.
                                    </Text>
                                </Card>
                            ) : (
                                <BatteryInfoCard
